    ...
    const initButton = (el, dir) => {
      if (el) {
        if (params.addIcons && el.matches('.swiper-button-next,.swiper-button-prev') && !el.querySelector('svg')) {
          ...
          Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["s"])(tempEl, arrowSvg);
...
function updateSlides() {
  ...
  for (let i = 0; i < slidesLength; i += 1) {
    ...
    if (slide) {
      ...
      if (Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["q"])(slide, 'display') === 'none') continue; // eslint-disable-line
    }
...
function loopCreate(slideRealIndex, initial) {
  ...
  const clearBlankSlides = () => {
    const slides = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["e"])(slidesEl, `.${params.slideBlankClass}`);
    slides.forEach(el => {
      el.remove();
    });
    if (slides.length > 0) {
...
/* harmony import */ var _modules_animations_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/animations.js */ "./js/modules/animations.js");
/* harmony import */ var _modules_animations_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_animations_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_map_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/map.js */ "./js/modules/map.js");
/* harmony import */ var _modules_map_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_map_js__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _modules_nav_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/nav.js */ "./js/modules/nav.js");
/* harmony import */ var _modules_slider_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/slider.js */ "./js/modules/slider.js");
/* harmony import */ var _modules_catalog_filter_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/catalog-filter.js */ "./js/modules/catalog-filter.js");
/* harmony import */ var _modules_range_slider_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/range-slider.js */ "./js/modules/range-slider.js");
/* harmony import */ var _modules_form_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/form.js */ "./js/modules/form.js");
/* harmony import */ var _modules_img_paralax_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/img-paralax.js */ "./js/modules/img-paralax.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  Object(_modules_catalog_filter_js__WEBPACK_IMPORTED_MODULE_10__["openCloseCatalogFilter"])();
  Object(_modules_catalog_filter_js__WEBPACK_IMPORTED_MODULE_10__["openCloseFilterGroup"])();
  Object(_utils_mobile_vh_fix_js__WEBPACK_IMPORTED_MODULE_0__["mobileVhFix"])();
  Object(_modules_slider_js__WEBPACK_IMPORTED_MODULE_9__["checkWidth"])();
  Object(_modules_nav_js__WEBPACK_IMPORTED_MODULE_8__["switchingNav"])();
  Object(_modules_modal_js__WEBPACK_IMPORTED_MODULE_7__["openCloseModal"])();
  Object(_modules_range_slider_js__WEBPACK_IMPORTED_MODULE_11__["createRangeSlider"])();
  Object(_modules_catalog_filter_js__WEBPACK_IMPORTED_MODULE_10__["changeLikesIcon"])();
  Object(_modules_form_js__WEBPACK_IMPORTED_MODULE_12__["initEmailValidation"])();
  Object(_modules_img_paralax_js__WEBPACK_IMPORTED_MODULE_13__["initParallax"])();
  // Modules
  // ---------------------------------
...
var cardList = document.querySelectorAll('.hero__card');
...
/*!**************************************!*\
  !*** ./js/modules/catalog-filter.js ***!
  \**************************************/
/*! exports provided: openCloseCatalogFilter, openCloseFilterGroup, changeLikesIcon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openCloseCatalogFilter", function() { return openCloseCatalogFilter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openCloseFilterGroup", function() { return openCloseFilterGroup; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeLikesIcon", function() { return changeLikesIcon; });
var filterButton = document.querySelector('.companions-filter__button');
var countriesFilter = document.querySelector('.companions-filter__list');
var countriesFilterButton = document.querySelector('.companions-filter__list button');
var form = document.querySelector('.form__wrapper');
var isDesktop = window.innerWidth > 1023;
var isMobile = window.innerWidth < 768;
var isTablet = window.matchMedia('(min-width: 768px) and (max-width: 1023px)');
function openCloseCatalogFilter() {
  if (filterButton) {
...
function countriesSorter() {
  if (isTablet) {
    var accordionList = document.querySelector('.companions-filter__alphabet-list');
    var filterLetters = accordionList.querySelectorAll('.companions-filter__item h3');
    if (accordionList && accordionList.firstElementChild) {
      var firstItem = accordionList.firstElementChild;
      firstItem.classList.add('is-open');
    }
    console.log(filterLetters);
    filterLetters.forEach(function (letter) {
      letter.addEventListener('click', function () {
        var currentItem = letter.parentElement;
        if (!currentItem.classList.contains('is-open')) {
          var openItem = accordionList.querySelector('.companions-filter__item.is-open');
...
function openCloseFilterGroup() {
  if (form) {
    if (isDesktop || isMobile) {
      var formGroup = form.querySelectorAll('fieldset');
      formGroup.forEach(function (group) {
        var title = group.querySelector('legend');
        var list = group.querySelector('.form__accordeon-content');
...
function closeFilter() {
  ...
  if (isMobile) {
    var filterButtonsList = document.querySelector('.companions-filter__buttons-list');
...
function changeLikesIcon() {
  var likesButtons = document.querySelectorAll('.companions-card__likes-counter');
  likesButtons.forEach(function (el) {
    el.addEventListener('click', function () {
      var liked = el.getAttribute('data-liked') === 'true';
...
var input = document.querySelector('.interested__input-wrapper input');
var button = document.querySelector('.interested__input-wrapper button');
var error = document.querySelector('.interested__input-error');
function validateEmail() {
  var email = input.value.trim();
  input.classList.remove('invalid');
  error === null || error === void 0 ? void 0 : error.classList.remove('show');
  if (!email) {
...
var images = document.querySelectorAll('.about__img-desktop, .about__img-tablet, .about__img-mobile');
var maxOffset = 250;
function initParallax() {
  ...
  function handleScroll() {
    ...
    var startWhen = viewportHeight * 0.35;
    images.forEach(function (img) {
      var rect = img.getBoundingClientRect();
      var elementTop = rect.top;
      if (elementTop <= startWhen) {
        var progress = Math.min(1, (startWhen - elementTop) / (viewportHeight - startWhen));
        var offset = progress * maxOffset;
        img.style.transform = "translateY(".concat(offset, "px)");
      } else {
...
var center = [59.93863106417265, 30.323036499999905];
function init() {
...
var openModalButton = document.querySelector('.profile__button');
var closeModalButton = document.querySelector('.modal__content button');
...
/*!***************************!*\
  !*** ./js/modules/nav.js ***!
  \***************************/
/*! exports provided: switchingNav */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "switchingNav", function() { return switchingNav; });
var header = document.querySelector('.header');
var nav = document.querySelector('.nav');
var navToggle = nav.querySelector('.nav__button');
var body = document.body;
var overlay = document.querySelector('.overlay');
...
/* harmony import */ var _vendor_nouislider_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/nouislider.mjs */ "./js/vendor/nouislider.mjs");
...
function createRangeSlider() {
  if (form) {
    ...
    _vendor_nouislider_mjs__WEBPACK_IMPORTED_MODULE_0__["default"].create(rangeSlider, {
      start: [30, 100],
      connect: true,
      range: {
        'min': 0,
...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: checkWidth */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkWidth", function() { return checkWidth; });
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "../node_modules/swiper/swiper.mjs");
/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper/modules */ "../node_modules/swiper/modules/index.mjs");


var slider = document.querySelector('.direction__slider');
var sliderList = document.querySelector('.direction__slide-list');
var slides = document.querySelectorAll('.direction__item');
var isMobile = window.innerWidth < 768;
var countrySlider = null;
function checkWidth() {
  if (slider) {
    if (isMobile) {
      clearSwiperClass();
...
function initSwiper() {
  ...
  var countrySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](slider, {
    direction: 'vertical',
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Mousewheel"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Autoplay"]],
    loop: true,
    slidesPerView: 3,
    slidesPerGroup: 1,
    centeredSlides: true,
